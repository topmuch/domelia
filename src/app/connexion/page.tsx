// Page de connexion - Domelia.fr
import Link from "next/link";
import { LoginForm } from "@/components/domelia/LoginForm";
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md shadow-luxe">
        <div className="container-domelia">
          <div className="flex items-center justify-between h-16">
            ...
            <Link
              href="/inscription"
              className="bg-[#560591] text-white font-semibold px-5 py-2 rounded-xl transition-all duration-300 hover:bg-[#3D0466] hover:shadow-lg"
            >
              S&apos;inscrire
            </Link>
          </div>
      ...
      <div className="pt-24 pb-16 px-4">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-center text-sm text-[#94A3B8] mt-6">
            ...
            <Link href="/inscription" className="text-[#560591] hover:underline font-medium">
              Creer un compte
            </Link>
          </p>
        </div>
